...
urlpatterns = [
    ...
    path('profile/privacy_settings',views.privacy_settings, name='privacy_settings'),
    path('profile/edit_privacy_settings/', views.edit_privacy_settings,name='edit_privacy_settings'),
